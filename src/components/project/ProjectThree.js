              ...
              <div
                ...
                style={{
                  backgroundImage:
                    "url(" +
                    publicUrl +
                    "assets/images/project/projects-v3-img5.jpg)",
                }}
              >
                ...
                <ul className="projects-three__bg-two-content">
                  ...
                  <li className="text-center">
                    ...
                    <div className="title-box">
                      <h2>
                        <a href="#">
                          Eco Doors <br /> for Modern Living
                        </a>
                      </h2>
                    </div>
                  </li>
                        ...
                        <div className="projects-three__single">
                          <div className="projects-three__single-img">
                            <img
                              src={
                                publicUrl +
                                "assets/images/project/projects-v3-img1.jpg"
                              }
                              alt="#"
                            />
                        ...
                        <div className="projects-three__single mt45">
                          <div className="projects-three__single-img">
                            <img
                              src={
                                publicUrl +
                                "assets/images/project/projects-v3-img2.jpg"
                              }
                              alt="#"
                            />
                            <div className="overlay-content">
                        ...
                        <div className="projects-three__single">
                          <div className="projects-three__single-img">
                            <img
                              src={
                                publicUrl +
                                "assets/images/project/projects-v3-img3.jpg"
                              }
                              alt="#"
                            />
                            <div className="overlay-content">
                        ...
                        <div className="projects-three__single mt45">
                          <div className="projects-three__single-img">
                            <img
                              src={
                                publicUrl +
                                "assets/images/project/projects-v3-img4.jpg"
                              }
                              alt="#"
                            />
                            <div className="overlay-content">
                  ...
                  >
                    <div className="swiper-wrapper">
                      <SwiperSlide className="swiper-slide">
                        <img
                          src={
                            publicUrl + "assets/images/brand/brand-v2-img1.png"
                          }
                          alt="#"
                        />
                      </SwiperSlide>
                      ...
                      <SwiperSlide className="swiper-slide">
                        <img
                          src={
                            publicUrl + "assets/images/brand/brand-v2-img2.png"
                          }
                          alt="#"
                        />
                      </SwiperSlide>
                      ...
                      <SwiperSlide className="swiper-slide">
                        <img
                          src={
                            publicUrl + "assets/images/brand/brand-v2-img3.png"
                          }
                          alt="#"
                        />
                      </SwiperSlide>
                      ...
                      <SwiperSlide className="swiper-slide">
                        <img
                          src={
                            publicUrl + "assets/images/brand/brand-v2-img4.png"
                          }
                          alt="#"
                        />
                      </SwiperSlide>
                      ...
                      <SwiperSlide className="swiper-slide">
                        <img
                          src={
                            publicUrl + "assets/images/brand/brand-v2-img5.png"
                          }
                          alt="#"
                        />
                      </SwiperSlide>
