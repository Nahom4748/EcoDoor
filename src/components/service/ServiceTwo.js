              ...
              <div className="container">
                <div className="sec-title style2 text-center">
                  ...
                  <h2 className="sec-title__title">
                    At Charot, we make and deliver smart solutions for better
                    living.
                  </h2>
                </div>
                    ...
                    <div className="services-two__single">
                      <div className="services-two__single-inner">
                        ...
                        <div className="services-two__single-content">
                          ...
                          <p>
                            We provide tailored Wood-Plastic Composite (WPC)
                            products that meet the unique requirements of
                    ...
                    <div className="services-two__single">
                      <div className="services-two__single-inner">
                        ...
                        <div className="services-two__single-content">
                          ...
                          <p>
                            Our expert team offers full support from product
                            selection to installation guidance, ensuring a
                    ...
                    <div className="services-two__single">
                      <div className="services-two__single-inner">
                        ...
                        <div className="services-two__single-content">
                          ...
                          <p>
                            We stay connected with our clients even after
                            installation, ensuring long-term satisfaction and
                            addressing any future needs or questions.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="services-two__single">
                      <div className="services-two__single-inner">
                        ...
                        <div className="services-two__single-content">
                          ...
                          <p>
                            Our operations are 100% eco-friendly, with a
                            zero-waste production system that supports
                    ...
                    <div className="services-two__single">
                      <div className="services-two__single-inner">
                        ...
                        <div className="services-two__single-content">
                          ...
                          <p>
                            Every Charot product goes through strict quality
                            control processes, aesthetics, and customer
                            satisfaction.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="services-two__single">
                      <div className="services-two__single-inner">
                        ...
                        <div className="services-two__single-content">
                          ...
                          <p>
                            We believe in building lasting partnerships based on
                            trust, loyalty, and a shared commitment to
                            excellence.
                          </p>
                        </div>
                      </div>
