            ...
            <section className="work-process-one">
              ...
              <div className="shape2">
                <img
                  src={
                    publicUrl +
                    "assets/images/shapes/work-process-v1-shape1.png"
                  }
                  alt="#"
                />
              </div>
                  ...
                  >
                    <div className="work-process-one__single">
                      ...
                      <div className="work-process-one__single-content text-center">
                        ...
                        <p>
                          Evaluate the specific needs and preferences for your
                          door design before initiating the manufacturing
                          process.
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    <div className="work-process-one__single style2 mt100">
                      ...
                      <div className="work-process-one__single-content text-center">
                        ...
                        <p>
                          Create customized door designs that align with the
                          style, functionality, and quality you desire.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="work-process-one__single mt50">
                      ...
                      <div className="work-process-one__single-content text-center">
                        ...
                        <p>
                          Utilize precise techniques and premium materials to
                          build the door according to the approved design
                          specifications.
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    <div className="work-process-one__single style2">
                      ...
                      <div className="work-process-one__single-content text-center">
                        ...
                        <p>
                          Ensure quality checks are performed before delivering
                          the finished door, ensuring it meets your expectations
