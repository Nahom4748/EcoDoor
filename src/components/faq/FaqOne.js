              ...
              <div className="col-xl-6 col-lg-6">
                <div className="faq-one__progress">
                  ...
                  <div className="faq-one__progress-single">
                    <img
                      src="../../../public/assets/images/faq.jpg"
                      alt="Product Durability, Eco-Friendly Manufacturing, Customer Satisfaction"
                  ...
                  <ul className="accordion-box">
                    <li className="accordion block active-block">
                      ...
                      <div className="acc-content current">
                        <p>
                          Eco doors are made from a combination of recycled wood
                          and plastic, offering durability, insulation, and
                    ...
                    <li className="accordion block">
                      ...
                      <div className="acc-content">
                        <p>
                          Yes, we can provide samples for you to review before
                    ...
                    <li className="accordion block">
                      ...
                      <div className="acc-content">
                        <p>
                          Our doors can be customized in various sizes, colors,
                          and finishes to meet your specific design preferences
                          and requirements.
                        </p>
                      </div>
                    </li>
                    ...
                    <li className="accordion block">
                      ...
                      <div className="acc-content">
                        <p>
                          Absolutely! We are committed to sustainable practices,
                          using eco-friendly materials in our manufacturing
                          processes.
                        </p>
                      </div>
                    </li>
                    ...
                    <li className="accordion block">
                      ...
                      <div className="acc-content">
                        <p>
                          Yes, our doors are waterproof, they provide excellent
                          protection against moisture; making them suitable for
