          ...
          <div className="mobile-nav__content">
            <div className="logo-box">
              <Link to={process.env.PUBLIC_URL + `/`} aria-label="logo image">
                <img
                  src={publicUrl + "assets/images/resources/logo.png"}
                  width="135"
                  alt=""
                />
              </Link>
            ...
            <ul className="mobile-nav__contact list-unstyled">
              ...
              <li>
                ...
                <a href="tel:+251908 676767">+251908 676767</a>
              </li>
            </ul>
            ...
            <div className="mobile-nav__top">
              <div className="mobile-nav__social">
                ...
                <a
                  href="https://web.facebook.com/people/Charot-Eco-Doors/pfbid02HKC258FgsG2t2mNm3fqNi78Ttzb3sdkqW7kL4Hkf8qZTciRmZTV9fLTiTwAjonBQl/?rdid=EYOU075vyYWKlYWe&share_url=https%3A%2F%2Fweb.facebook.com%2Fshare%2F15guT785js%2F%3F_rdc%3D1%26_rdr"
                  target="_blank"
                  rel="noopener noreferrer"
                >
